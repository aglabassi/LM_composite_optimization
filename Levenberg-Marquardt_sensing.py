...
This code implements a unified Levenberg-Marquardt scheme that works for both CP–tensor and 
matrix factorization  and sensing models. 
"""
...
###############################################################################
# 4. Unified Linear Operator Function for conjugate gradient
###############################################################################
...
if __name__ == '__main__':
    ...
    tensor = True         # Set tensor=True for CP–tensor and tensor=False for matrix factorization.
